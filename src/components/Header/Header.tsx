          ...
          <div id="header_sticky" className="header__elem">
            <div className="hamburger-menu">
              ...
              <ul className="menu__box">
                ...
                <Link className="menu__item" to={"/dishes/pizza"}>
                  Пицца
                </Link>
                <Link className="menu__item" to={"/dishes/combo"}>
                  Комбо
                </Link>
                <Link className="menu__item" to={"/dishes/snacks"}>
                  Закуски
                </Link>
                <Link className="menu__item" to={"/dishes/sweets"}>
                  Десерты
                </Link>
                <Link className="menu__item" to={"/dishes/drinks"}>
                  Напитки
                </Link>
              </ul>
            </div>
